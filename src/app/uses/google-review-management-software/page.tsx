...
export function generateMetadata(): Metadata {
  return {
    title: "Google Review Management Software | Typani",
...
export default function GoogleReviewManagementSoftware() {
  return (
    <UsesPageLayout
      ...
      tagline="Typani is the simplest way to manage all your Google reviews — monitor new reviews, generate AI responses, and track your reputation over time."
      featureHeading="Everything in One Google Review Management Tool"
      featureBody="From the moment a review is posted to the second you hit publish on a response, Typani handles the entire Google review management workflow — without the complexity of enterprise software."
      featurePoints={[
      ...
      examples={[
        {
          stars: 2,
          review: "Used a competitor's tool for two years. It was expensive and the responses it generated were obviously templated. Switched to Typani and the difference in response quality is immediately obvious.",
        ...
        {
          stars: 5,
          review: "Managing 8 locations used to mean 8 logins and an hour of my morning. Now it's one screen and 10 minutes. Typani is genuinely one of the best tools in our stack.",
          response: "Eight locations and one screen — that's exactly the efficiency we aim for. Thank you for trusting Typani with such an important part of your reputation. We'll keep building to make those 10 minutes even more productive.",
        },
      ]}
      ...
      whyBody={[
        ...
        "For multi-location businesses, the ROI is even clearer. Without a centralized tool, managing reviews across locations means inconsistent coverage — some locations get responses, others don't. Typani standardizes the experience across your entire portfolio.",
      ]}
