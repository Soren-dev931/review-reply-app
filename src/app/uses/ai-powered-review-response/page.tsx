...
export function generateMetadata(): Metadata {
  return {
    title: "AI-Powered Review Response | Reviewly",
...
export default function AiPoweredReviewResponse() {
  return (
    <UsesPageLayout
      ...
      featureBody="Reviewly uses AI to analyze the tone, content, and star rating of each review, then generates a tailored response that fits your business — not a one-size-fits-all template."
      featurePoints={[
      ...
      whyBody={[
        "Responding to reviews consistently is one of the highest-leverage things a local business can do — but it's time-consuming if done manually. AI-powered response tools like Reviewly give you the speed of automation with the quality of a handwritten reply.",
      ...
      featureImageAlt="Reviewly AI review response dashboard"
