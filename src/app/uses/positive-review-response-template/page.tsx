...
export function generateMetadata(): Metadata {
  return {
    title: "Positive Review Response Templates | Reviewly",
...
export default function PositiveReviewResponseTemplate() {
  return (
    <UsesPageLayout
      ...
      tagline="Your 5-star reviewers deserve more than copy-paste. Use these templates as a starting point — then personalize them in seconds with Reviewly's AI."
      ...
      whyBody={[
        ...
        "Reviewly's AI takes templates to the next level: instead of inserting generic phrases, it generates a response built around what the reviewer actually said. You get the efficiency of a template with the specificity of a custom reply. Try it free and see the difference immediately.",
      ]}
      ...
      featureImageAlt="Reviewly positive review template library"
