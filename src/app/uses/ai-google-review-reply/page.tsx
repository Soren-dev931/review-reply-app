...
export function generateMetadata(): Metadata {
  return {
    title: "AI Google Review Reply Generator | Reviewly",
...
export default function AiGoogleReviewReply() {
  return (
    <UsesPageLayout
      ...
      featureBody="Reviewly reads the full content of each review — the stars, the specific complaints or praise — and generates a reply that sounds like a real business owner, not a chatbot."
      featurePoints={[
      ...
      whyBody={[
        "Most businesses know they should respond to Google reviews — but writing a genuine, thoughtful reply for every review takes real time. AI changes that. With Reviewly, you get responses that are specific to each review, not recycled templates that customers can spot from a mile away.",
      ...
      featureImageAlt="Reviewly dashboard for managing Google replies"
