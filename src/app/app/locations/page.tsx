        ...
        <form onSubmit={handleAdd} className="card p-6 mb-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
            <p className="text-blue-800 text-xs">
              🔗 <strong>Google Business Profile integration coming soon.</strong> For now, add your business manually. When the integration is ready, you&apos;ll be able to connect your Google profile for automatic review monitoring.
            </p>
          </div>
      ...
      {simulateResult && (
        <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 mb-6">
          <div className="flex items-center justify-between">
            <p className="text-emerald-800 text-sm">{simulateResult}</p>
            <button onClick={() => setSimulateResult('')} className="text-emerald-600 text-sm">✕</button>
          </div>
        </div>
      )}
            ...
            {editingId === loc.id ? (
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {simulateLoading === loc.id ? '...' : '🧪 Simulate Review'}
                  </button>
                  <button
